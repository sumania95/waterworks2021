...
Public Class AllocateZonesCluster
    ...
    Private Sub TxCluster_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txCluster.KeyPress
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If txCluster.Text = String.Empty Then
        ...
        Else
            Try
                If (MsgBox("Are you sure you want to update this record", vbYesNo + vbQuestion) = vbYes) Then
                    cn.Open()
                    cm = New MySqlCommand("sp_updateCustomerCluster", cn)
                    cm.CommandType = CommandType.StoredProcedure
                    cm.Parameters.AddWithValue("p1", txAccount.Text)
                    cm.Parameters.AddWithValue("p2", "Changed Cluster")
                    cm.Parameters.AddWithValue("p3", Main.ToolStripLabel3.Text)
                    cm.Parameters.AddWithValue("Cluster", txCluster.Text)
                    cm.ExecuteNonQuery()
                    cn.Close()

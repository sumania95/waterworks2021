...
Public Class PrintRequestFormForDCorMPO

    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Me.Dispose()
    End Sub

    Private Sub PrintRequestFormForDCorMPO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub loadreport()
        Try
            ...
            With ReportViewer1.LocalReport
                .ReportPath = Application.StartupPath & "\Report\RequestForDC.rdlc"
                .DataSources.Clear()
            End With

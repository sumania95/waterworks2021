...
Public Class Activity_Log
    ...
    Public Sub loadrecord()
        Try
            ...
            cn.Open()
            cm = New MySqlCommand("sp_selectActivityLogs", cn)
            ...
            While dr.Read
                ...
                DataGridView1.Rows.Add(i, dr.Item("Id").ToString, dr.Item("Lastname").ToString + ", " + dr.Item("Firstname").ToString + " " + dr.Item("Middlename").ToString, dr.Item("Summary").ToString, ddate.ToString("MM-dd-yyyy"), ddate.ToString("hh:mm:ss tt"), dr.Item("User").ToString)
            End While
            dr.Close()
            cn.Close()
